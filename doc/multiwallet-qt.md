...
In order to support loading of multiple wallets in lemonad-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lemonad.cpp.
...
Changes to lemonad.cpp
----------------------
lemonad.cpp is the entry point into lemonad-qt, and as such, will require some minor modifications to provide hooks for
