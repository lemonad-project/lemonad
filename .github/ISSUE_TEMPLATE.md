...
This issue tracker is only for technical issues related to LemonAd Core.
General LemonAd questions and/or support requests and are best directed to the [LemonAd Slack](http://lemonad.slack.com).
...
### What version of LemonAd Core are you using?
