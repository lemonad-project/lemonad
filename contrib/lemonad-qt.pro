...
RESOURCES += src/qt/lemonad.qrc src/qt/lemonad_locale.qrc

TRANSLATIONS += src/qt/locale/lemonad_bg.ts \
                src/qt/locale/lemonad_de.ts \
                src/qt/locale/lemonad_en.ts \
                src/qt/locale/lemonad_es.ts \
                src/qt/locale/lemonad_fi.ts \
                src/qt/locale/lemonad_fr.ts \
                src/qt/locale/lemonad_it.ts \
                src/qt/locale/lemonad_ja.ts \
                src/qt/locale/lemonad_pl.ts \
                src/qt/locale/lemonad_pt.ts \
                src/qt/locale/lemonad_ru.ts \
                src/qt/locale/lemonad_sk.ts \
                src/qt/locale/lemonad_sv.ts \
                src/qt/locale/lemonad_vi.ts \
                src/qt/locale/lemonad_zh_CN.ts \
                src/qt/locale/lemonad_zh_TW.ts
