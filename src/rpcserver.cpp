...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "LemonAd server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lemonad features */
        {"lemonad", "masternode", &masternode, true, true, false},
        {"lemonad", "listmasternodes", &listmasternodes, true, true, false},
        {"lemonad", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lemonad", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lemonad", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lemonad", "masternodedebug", &masternodedebug, true, true, false},
        {"lemonad", "startmasternode", &startmasternode, true, true, false},
        {"lemonad", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lemonad", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lemonad", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lemonad", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lemonad", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lemonad", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lemonad", "mnbudget", &mnbudget, true, true, false},
        {"lemonad", "preparebudget", &preparebudget, true, true, false},
        {"lemonad", "submitbudget", &submitbudget, true, true, false},
        {"lemonad", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lemonad", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lemonad", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lemonad", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lemonad", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lemonad", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lemonad", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lemonad", "checkbudgets", &checkbudgets, true, true, false},
        {"lemonad", "mnsync", &mnsync, true, true, false},
        {"lemonad", "spork", &spork, true, true, false},
        {"lemonad", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lemonad", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lemonadd, or the -server option to lemonad-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lemonad-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52273/\n";
}
