...
{
public:
    /// Is the inputs associated with this public key? (and there is Masternode Collateral LAD - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of lemonad.
