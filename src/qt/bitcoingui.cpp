                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LemonAd Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LemonAd address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lemonad: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LemonAd Core"), this);
    aboutAction->setStatusTip(tr("Show information about LemonAd Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LemonAd"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LemonAd addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LemonAd addresses"));
    ...
    openAction->setStatusTip(tr("Open a LemonAd: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LemonAd Core help message to get a list with possible LemonAd command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LemonAd Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LemonAd network", "", count));
}
...
{
    QString strTitle = tr("LemonAd Core"); // default title
