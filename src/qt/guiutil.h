...
/** Utility functions used by the LemonAd Qt UI.
 */
namespace GUIUtil
{
...
// Render LemonAd addresses in monospace font
...
// Parse "lemonad:" URI into recipient object, return true on successful parsing
