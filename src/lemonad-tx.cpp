...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LemonAd lemonad-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lemonad-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lemonad transaction") + "\n" +
                               "  lemonad-tx [options] -create [commands]   " + _("Create hex-encoded lemonad transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lemonad transaction
