...
#if defined(NDEBUG)
#error "LemonAd cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 60 * 60; //1H stake min age
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 210000 * COIN; //1% premine
    } 
    else if (nHeight > 0 && nHeight <= 300) {
            return 702.3 * COIN; //another 1% premine
    }
    else if (nHeight >= 301 && nHeight <= 43200) {
            return 0.69 * COIN; 
    }
    else if (nHeight >= 43201 && nHeight <= 129600) {
            return 2.08 * COIN;
            
            }
    else if (nHeight >= 129601 && nHeight <= 259200) {
            return 6.94 * COIN;
            }
    else if (nHeight >= 259201 && nHeight <= 388800) {
            return 8.33 * COIN;
            }
    ...
    else if (nHeight >= 648001 && nHeight <= 777600) {
            return 4.17 * COIN;
            }
    else if (nHeight >= 777601 && nHeight <= 907200) {
            return 4.86 * COIN;
            }
    else if (nHeight >= 907201 && nHeight <= 1036800) {
            return 2.78 * COIN;
            }
    else if (nHeight >= 1036801 && nHeight <= 1166400) {
            return 3.13 * COIN;
            }
    else if (nHeight >= 1166401 && nHeight <= 1296000) {
            return 3.47 * COIN;
            }
    else if (nHeight >= 1296001 && nHeight <= 1425600) {
            return 3.47 * COIN;
            }
    else if (nHeight >= 1425601 && nHeight <= 1555200) {
            return 2.08 * COIN;
            }
    else if (nHeight >= 1555201 && nHeight <= 1684800) {
            return 2.08 * COIN;
            }
    else if (nHeight >= 1684801 && nHeight <= 1814400) {
            return 2.08 * COIN;
            }
    else if (nHeight >= 1814401 && nHeight <= 1944000) {
            return 2.08 * COIN;
            }
    else if (nHeight >= 1944001 && nHeight <= 2073600) {
            return 1.39 * COIN;
            }
    else if (nHeight >= 2073601 && nHeight <= 2203200) {
            return 1.39 * COIN;
            }
    else if (nHeight >= 2203201 && nHeight <= 2332800) {
            return 1.39 * COIN;
            }
    else if (nHeight >= 2332801 && nHeight <= 2462400) {
            return 1.39 * COIN;
            }
    else if (nHeight >= 2462401) {
            return 1.04 * COIN;
    } 
 ...
 * Get Developer Fund
*/
int64_t GetDevFee(int nHeight, int64_t blockValue)
{
    int64_t res = 0;
    ...
    if (nHeight >= 259201) {
        res = blockValue * 0.05; //5% of total block value
    }
...
bool CheckBlock(const CBlock& block, CValidationState& state, bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig)
{
    ...
    if (block.IsProofOfStake()) {
        ...
        LogPrintf("CheckBlock() : height=%d stake_tx_height=%d required_confirmations=%d got=%d\n", chainActive.Tip()->nHeight, pindex->nHeight, Params().COINBASE_MATURITY(), chainActive.Tip()->nHeight - pindex->nHeight);
        if (chainActive.Tip()->nHeight - pindex->nHeight < Params().COINBASE_MATURITY())
